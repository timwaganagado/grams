...
d.close()
bj_image = {'c2':,'d2':,'h2':,'s2':,'c3':,'d3':,'h3':,'s3':,'c4':,'d4':,'h4':,'s4':,'c5':,'d5':,'h5':,'s5':,'c6':,'d6':,'h6':,'s6':,'c7':,'d7':,'h7':,'s7':,'c8':,'d8':,'h8':,'s8':,'c9':,'d9':,'h9':,'s9':,'ct10':,'dt10':,'ht10':,'st10':,'cj10':,'dj10':,'hj10':,'sj10':,'cq10':,'dq10':,'hq10':,'sq10':,'ck10':,'dk10':,'hk10':,'sk10':,'ca':,'da':,'ha':,'sa':}
while cont == 1:
   skip = 0
   loop = 1
   drawn = []
