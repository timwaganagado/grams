...
C.attacks = {'darkness':[5,5],'conduction':[20,1]}
...
C2.attacks = {'darkness':[5,5],'conduction':[20,1]}
...
mage.attacks = {'fire ball':[10,3],'lightning':[15,1],'miss':[0,1]}
...
mage2.attacks = {'fire ball':[10,3],'lightning':[15,1],'miss':[0,1]}
...
class ally():
    ...
    class sri():
        ...
        def attack(self,target,attack):
            for x in M.enemy:
                M.enemy[x][1] -= self.attacks[self.attack1][0]
        def support(self,target):
...
H.attacks = {H.attack1:[[10,15],heplane_ability1_img,vec(18, 31),[vec(18,31) + a for a in iconaura],False],H.attack2:[[5,0],heplane_ability2_img,vec(23,31),[vec(23,31) + a for a in iconaura],False],H.attack3:[[0,0],heplane_ability3_img,vec(28,31),[vec(28,31)+ a for a in iconaura],True]}
H.healdam = []
...
S.attacks = {S.attack1:[5,sri_ability1_img,vec(18,31),[vec(18,31) + a for a in iconaura],False],S.attack2:[2,sri_ability2_img,vec(23,31),[vec(23,31) + a for a in iconaura],True],S.attack3:[10,sri_ability3_img,vec(28,31),[vec(28,31)+a for a in iconaura],True]}
